...
This project has been cloned from the open source project: Bullet Train in order to get a quick jumpstart.

The vision of this project is to build up a Hub for independent makers. 


## Getting Started with Bullet Train boilerplate
